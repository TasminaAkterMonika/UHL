    ...
    render() {
        return (
            <div>
                ...
                <div className="center-search mt-4"  data-aos="fade-up" data-aos-duration="1000" style={{"position":"relative", "zIndex":"999999"}}>
                   <form className="d-flex">
                      <div className="input-group mb-3 home_search_input_section">
                        ...
                        <span className="input-group-text" id="basic-addon1"><img src={search_icon} alt="search-icon" style={{"width": "40px"}}/></span>
