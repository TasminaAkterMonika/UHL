...
class AddDepartment extends Component {
    ...
    validateForm() {
        ...
        if (!this.state.department_name) {
            formIsValid = false;
            errors["department_name"] = "*Please enter your doctor name.";
        }
        if (!this.state.department_image) {
            formIsValid = false;
            errors["department_image"] = "*Please enter your doctor degree.";
        }
    ...
    handleSubmit = event => {
        ...
        if (this.validateForm()) {
            ...
            toast.error('Department name and image are required field', {
                position: toast.POSITION.BOTTOM_RIGHT
            });
        }
    }
